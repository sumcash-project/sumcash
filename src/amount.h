...
static const CAmount MAX_MINT_PROOF_OF_WORK = 2000000; // 100,000 for the initial PoW;
static const CAmount MAX_MINT_PROOF_OF_WORK_V10 = 2000000; // 100,000 for the initial PoW;
