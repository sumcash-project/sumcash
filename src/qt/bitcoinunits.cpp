...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Sumcash");
    case mBTC: return QString("Milli-Sumcash (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Sumcash (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
