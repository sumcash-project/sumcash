...
//    connect(multisigAction, SIGNAL(triggered()), this, SLOT(gotoMultisigPage()));
    ...
    openForumAction->setStatusTip(tr("Open talk.sumcash.org in a web browser."));
...
void BitcoinGUI::openWeb() {
    QDesktopServices::openUrl(QUrl("https://sumcash.org"));
}

void BitcoinGUI::openDonate() {
    QDesktopServices::openUrl(QUrl("https://www.sumcash.org/foundation"));
}
...
void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.sumcash.org"));
}
